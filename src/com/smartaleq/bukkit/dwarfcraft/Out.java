...
public class Out {
	...
	protected void tutorial(CommandSender sender, int i) {
		if (i == 1)
			sendMessage(sender, Messages.Fixed.TUTORIAL1.getMessage(),
					"&6[&dDC&6] ");
		else if (i == 2)
			sendMessage(sender, Messages.Fixed.TUTORIAL2.getMessage(),
					"&6[&dDC&6] ");
		else if (i == 3)
			sendMessage(sender, Messages.Fixed.TUTORIAL3.getMessage(),
					"&6[&dDC&6] ");
		else if (i == 4)
			sendMessage(sender, Messages.Fixed.TUTORIAL4.getMessage(),
					"&6[&dDC&6] ");
		else if (i == 5)
			sendMessage(sender, Messages.Fixed.TUTORIAL5.getMessage(),
					"&6[&dDC&6] ");
		else if (i == 6)
			sendMessage(sender, Messages.Fixed.TUTORIAL6.getMessage(),
					"&6[&dDC&6] ");
	}
