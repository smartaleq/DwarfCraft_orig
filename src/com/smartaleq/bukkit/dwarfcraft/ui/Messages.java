...
public class Messages {
	...
	public enum Fixed{
		...
		SERVERRULESMESSAGE(
				"This is a dummy General Rules Message, please place a message in your messages.config"), 
		INFO(
		...
		TUTORIAL5(
				"&fYou now know the basic commands you need to succeed and develop as a dwarf. " 
